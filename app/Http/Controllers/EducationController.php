...
class EducationController extends Controller
{
    ...
    {
        // Fetch BSED and BEED department timesheets
        $departments = ['BSED', 'BEED'];
        $fulltimeTimesheets = FulltimeTimesheet::whereIn('department', $departments)->get();
        $parttimeTimesheets = ParttimeTimesheet::whereIn('department', $departments)->get();
