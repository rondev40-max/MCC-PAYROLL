...
return new class extends Migration
{
    ...
    {
    Schema::create('parttime_timesheets', function (Blueprint $table) {
        ...
        $table->decimal('rate_per_hour', 8, 2)->default(120.00); // Different rate for part-time
...
{
    Schema::dropIfExists('parttime_timesheets');
}
