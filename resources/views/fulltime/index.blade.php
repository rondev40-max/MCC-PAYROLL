...
<head>
  ...
  <title>Instructor Fulltime Timesheet — MCC Payroll</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .day-input.saving, .field-input.saving { background-color: #fef3c7; border-color: #fcd34d; }
    .day-input.saved, .field-input.saved { background-color: #ecfdf5; border-color: #a7f3d0; }
    .day-input.error, .field-input.error { background-color: #fef2f2; border-color: #fecaca; }
  ...
  <div class="container-fluid">
    <div class="timesheet-card">
      ...
      <div class="print-header d-none">
        ...
        <h5 class="text-secondary mb-2">Instructor Fulltime Timesheet</h5>
      ...
      <div class="header-section">
        ...
        <div class="header-actions">
          ...
          <a href="{{ route('fulltime.create') }}" class="btn-action-primary">
      ...
      <div class="controls-bar">
        <form method="GET" action="{{ route('fulltime.index') }}" class="filter-form">
      ...
      <div class="table-responsive-container">
        <table class="timesheet-table">
          <thead>
            <tr>
              <th style="min-width: 160px; text-align: left;">Names</th>
          ...
          <tbody>
            ...
            <tr>
              <td class="col-name">{{ $timesheet->employee_name }}</td>
              ...
              <td id="total-hour-{{ $timesheet->id }}" class="fw-bold">{{ is_numeric($timesheet->total_hour) && floor($timesheet->total_hour) == $timesheet->total_hour ? number_format($timesheet->total_hour, 0) : $timesheet->total_hour }}</td>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function calculateTotals(row) {
          ...
          if (totalHonorariumElement) {
            totalHonorariumElement.textContent = `₱${totalHonorarium.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}`;
          }
      ...
      function saveAllData(timesheetId, row) {
        ...
        statusIcon.innerHTML = `<svg class="loading-spinner" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="10" stroke-dasharray="32" stroke-dashoffset="10"/></svg>`;
