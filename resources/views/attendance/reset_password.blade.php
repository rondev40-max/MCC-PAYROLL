...
<head>
    ...
    <title>Verify OTP - Attendance Checker</title>
    ...
    <style>
        *, *::before, *::after {
        ...
        /* OTP field: centred, spaced digits, full-width */
        .input-group input[name="otp"] {
            width: 100%;
            padding: 16px 14px;
        ...
        .input-group input[name="otp"]:focus {
            border-color: #3498db;
            outline: none;
            box-shadow: 0 0 0 4px rgba(52, 152, 219, 0.15);
        }

        .input-group input[name="otp"].is-invalid {
            border-color: #e74c3c;
        }
...
<body>
    <main>
        ...
        <div class="right-section">
            <div class="container">
                ...
                <p class="subtitle">Enter the 6-digit code sent to your registered email address to reset your password.</p>
                ...
                <form action="{{ route('attendance.verify') }}" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <input
                            ...
                            @error('otp') class="is-invalid" @enderror
                        >
                        @error('otp')
                ...
                <div class="links">
                    <a href="{{ route('attendance.forgot.form') }}">
    ...
    <script>
        ...
        // Only allow numeric input in the OTP field
