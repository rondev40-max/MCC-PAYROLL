...
<head>
  <meta charset="UTF-8">
  <title>Edit Watchman Timesheet</title>
...
<body>
  <div class="main-content">
    <h2><i class="bi bi-pencil-square"></i> Edit Watchman Timesheet</h2>
    ...
    <form action="{{ route('watchman.update', $timesheet->id) }}" method="POST">
      @csrf
      @method('PUT')
        ...
        <div class="col-md-3">
          <div class="form-floating">
            <select class="form-select @error('designation') is-invalid @enderror" id="designation" name="designation" required>
              ...
              <option value="BSIT Watchman" {{ old('designation', $timesheet->designation) == 'BSIT Watchman' ? 'selected' : '' }}>BSIT Watchman</option>
              <option value="Registrar Watchman" {{ old('designation', $timesheet->designation) == 'Registrar Watchman' ? 'selected' : '' }}>Registrar Watchman</option>
              <option value="Clinic Watchman" {{ old('designation', $timesheet->designation) == 'Clinic Watchman' ? 'selected' : '' }}>Clinic Watchman</option>
              <option value="Library Watchman" {{ old('designation', $timesheet->designation) == 'Library Watchman' ? 'selected' : '' }}>Library Watchman</option>
              <option value="Admin Watchman" {{ old('designation', $timesheet->designation) == 'Admin Watchman' ? 'selected' : '' }}>Admin Watchman</option>
              <option value="VP Office Watchman" {{ old('designation', $timesheet->designation) == 'VP Office Watchman' ? 'selected' : '' }}>VP Office Watchman</option>
              <option value="SAS Watchman" {{ old('designation', $timesheet->designation) == 'SAS Watchman' ? 'selected' : '' }}>SAS Watchman</option>
              <option value="IT Encoder" {{ old('designation', $timesheet->designation) == 'IT Encoder' ? 'selected' : '' }}>IT Encoder</option>
              <option value="Guidance Watchman" {{ old('designation', $timesheet->designation) == 'Guidance Watchman' ? 'selected' : '' }}>Guidance Watchman</option>
            </select>
      ...
      <div class="button-group">
        <a href="{{ route('watchman.index') }}" class="btn btn-secondary">
          Cancel
        </a>
