...
<head>
  <meta charset="UTF-8">
  <title>Add Watchman Timesheet</title>
...
<body>
  <div class="main-content">
    <h2><i class="bi bi-briefcase"></i> Add Watchman Timesheet</h2>
        ...
        <div class="col-md-3">
          <div class="form-floating">
            <select class="form-select @error('designation') is-invalid @enderror" id="designation" name="designation" required>
              ...
              <option value="BSIT Watchman" {{ old('designation') == 'BSIT Watchman' ? 'selected' : '' }}>BSIT Watchman</option>
              <option value="Registrar Watchman" {{ old('designation') == 'Registrar Watchman' ? 'selected' : '' }}>Registrar Watchman</option>
              <option value="Clinic Watchman" {{ old('designation') == 'Clinic Watchman' ? 'selected' : '' }}>Clinic Watchman</option>
              <option value="Library Watchman" {{ old('designation') == 'Library Watchman' ? 'selected' : '' }}>Library Watchman</option>
              <option value="Admin Watchman" {{ old('designation') == 'Admin Watchman' ? 'selected' : '' }}>Admin Watchman</option>
              <option value="VP Office Watchman" {{ old('designation') == 'VP Office Watchman' ? 'selected' : '' }}>VP Office Watchman</option>
              <option value="SAS Watchman" {{ old('designation') == 'SAS Watchman' ? 'selected' : '' }}>SAS Watchman</option>
              <option value="IT Encoder" {{ old('designation') == 'IT Encoder' ? 'selected' : '' }}>IT Encoder</option>
              <option value="Guidance Watchman" {{ old('designation') == 'Guidance Watchman' ? 'selected' : '' }}>Guidance Watchman</option>
            </select>
