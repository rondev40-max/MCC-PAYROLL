...
<head>
  ...
  <title>Staff Timesheet — MCC Payroll</title>
...
<body>
  ...
  <div class="container-fluid">
    <div class="timesheet-card">
      ...
      <div class="print-header d-none">
        ...
        <h5 class="text-secondary mb-2">Staff Timesheet</h5>
      ...
      <div class="header-section">
        ...
        <div class="header-actions">
          ...
          <a href="{{ route('staff.create') }}" class="btn-action-primary">
      ...
      <div class="controls-bar">
        <form method="GET" action="{{ route('staff.index') }}" class="filter-form">
            ...
            <tr>
              <td colspan="100" class="text-center py-5">
                <div class="empty-wrapper">
                  ...
                  <p class="mb-3">There are no staff timesheet entries to display.</p>
                  <a href="{{ route('staff.create') }}" class="btn btn-primary btn-action-primary">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                    Add First Timesheet
                  </a>
                </div>
  ...
  <script>
    ...
    // Calculations & Autosave (staff rules: total days is a day COUNT, not an hours
