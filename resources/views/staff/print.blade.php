...
<head>
    ...
    <title>Print - Staff Timesheet Detailed Compact</title>
...
<body>
    <div class="print-controls no-print">
        ...
        <a href="{{ route('staff.index') }}" class="btn btn-back">← Back to List</a>
    </div>

    <div class="print-header">
        <h1>MCC PAYROLL SYSTEM</h1>
        <h2>Staff Timesheet - Detailed</h2>
        <div class="meta-info">
            ...
            <tbody>
                @forelse($timesheets as $timesheet)
                    ...
                    <tr>
                        ...
                        <td>{{ ucfirst($timesheet->designation ?? 'Staff') }}</td>
                ...
                @empty
                    ...
                    <tr><td colspan="{{ $colspan }}" style="text-align: center; padding: 10px;">No staff timesheet records found.</td></tr>
                @endforelse
            </tbody>
            <tfoot>
