...
<body>
  <div class="main-content">
    <h2><i class="bi bi-pencil-square"></i> Edit Staff Timesheet</h2>
        ...
        <div class="col-md-3">
          <div class="form-floating">
            <select class="form-select @error('designation') is-invalid @enderror" id="designation" name="designation" required>
              ...
              <option value="BSIT Staff" {{ old('designation', $timesheet->designation) == 'BSIT Staff' ? 'selected' : '' }}>BSIT Staff</option>
              <option value="Registrar Staff" {{ old('designation', $timesheet->designation) == 'Registrar Staff' ? 'selected' : '' }}>Registrar Staff</option>
              <option value="Clinic Staff" {{ old('designation', $timesheet->designation) == 'Clinic Staff' ? 'selected' : '' }}>Clinic Staff</option>
              <option value="Library Staff" {{ old('designation', $timesheet->designation) == 'Library Staff' ? 'selected' : '' }}>Library Staff</option>
              <option value="Admin Staff" {{ old('designation', $timesheet->designation) == 'Admin Staff' ? 'selected' : '' }}>Admin Staff</option>
              <option value="VP Office Staff" {{ old('designation', $timesheet->designation) == 'VP Office Staff' ? 'selected' : '' }}>VP Office Staff</option>
              <option value="SAS Staff" {{ old('designation', $timesheet->designation) == 'SAS Staff' ? 'selected' : '' }}>SAS Staff</option>
              <option value="IT Encoder" {{ old('designation', $timesheet->designation) == 'IT Encoder' ? 'selected' : '' }}>IT Encoder</option>
              <option value="Guidance Staff" {{ old('designation', $timesheet->designation) == 'Guidance Staff' ? 'selected' : '' }}>Guidance Staff</option>
            </select>
