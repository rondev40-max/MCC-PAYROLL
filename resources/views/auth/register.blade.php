...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pw-rules li::before { content: "\25CB\00a0"; }
        .pw-rules li.ok { color: var(--strength-good); }
        .pw-rules li.ok::before { content: "\2713\00a0"; }
        .match-text { font-size: 0.78rem; margin-top: 6px; min-height: 1em; }
        .match-text.ok { color: var(--strength-good); }
        .match-text.bad { color: var(--danger-text); }
        ...
        <form action="{{ route('register.store') }}" method="POST" id="registerForm"
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper @error('email') is-invalid @enderror">
                    <input type="email" id="email" name="email" placeholder="yourname@gmail.com" value="{{ old('email') }}" required autocomplete="email" autocapitalize="none" spellcheck="false" inputmode="email">
                    <span class="input-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                    </span>
                </div>
                @error('email')<div class="field-error">{{ $message }}</div>@enderror
                <div class="field-hint">Use the exact email address the HR office has on file for you (for example your Gmail). We will email you a 6-digit code when you sign in.</div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field-hint">Avoid common passwords (like names plus 123). Three or four unrelated words with a number and a symbol works well, e.g. <em>Blue-Mango-Tricycle-42!</em></div>
            </div>
