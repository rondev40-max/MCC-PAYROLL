...
<body>
  <div class="main-content">
    <h2><i class="bi bi-clock-history"></i> Add Part-time Timesheet</h2>
    ...
    <form action="{{ route('parttime.store') }}" method="POST">
      ...
      <div class="row g-3 mb-4">
        <div class="col-md-12">
          <div class="form-floating">
            <input type="text" class="form-control" id="prov_abr" name="prov_abr" value="{{ old('prov_abr') }}" placeholder="Abbreviation">
            <label for="prov_abr">Province Abbreviation</label>
          </div>
        </div>
      </div>
      ...
      <div class="days-section">
        ...
        <small class="text-muted d-block mt-3"><i class="bi bi-info-circle me-1"></i>System will automatically calculate total hours based on daily entries.</small>
      </div>
      ...
      <div class="row g-3 mb-3">
        <div class="col-md-4">
          <div class="form-floating">
            <input type="number" step="0.01" class="form-control bg-light" id="total_hour" name="total_hour" value="{{ old('total_hour', 0) }}" readonly>
            <label for="total_hour">Total Hours</label>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-floating">
            <input type="number" step="0.01" class="form-control" id="rate_per_hour" name="rate_per_hour" value="{{ old('rate_per_hour', '120.00') }}" placeholder="0.00">
