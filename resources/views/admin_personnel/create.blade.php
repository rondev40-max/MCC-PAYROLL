...
<head>
  <meta charset="UTF-8">
  <title>Add Admin Personnel Timesheet</title>
...
<body>
  <div class="main-content">
    <h2><i class="bi bi-briefcase"></i> Add Admin Personnel Timesheet</h2>
    ...
    <form action="{{ route('admin-personnel.store') }}" method="POST">
      ...
      <input type="hidden" name="period" value="{{ request('period', '1-15') }}">
      ...
      <div class="row g-3 mb-4">
        ...
        <div class="col-md-3">
          <div class="form-floating">
            <select class="form-select @error('designation') is-invalid @enderror" id="designation" name="designation" required>
              ...
              <option value="BSIT Admin Personnel" {{ old('designation') == 'BSIT Admin Personnel' ? 'selected' : '' }}>BSIT Admin Personnel</option>
              <option value="Registrar Admin Personnel" {{ old('designation') == 'Registrar Admin Personnel' ? 'selected' : '' }}>Registrar Admin Personnel</option>
              <option value="Clinic Admin Personnel" {{ old('designation') == 'Clinic Admin Personnel' ? 'selected' : '' }}>Clinic Admin Personnel</option>
              <option value="Library Admin Personnel" {{ old('designation') == 'Library Admin Personnel' ? 'selected' : '' }}>Library Admin Personnel</option>
              <option value="Admin Admin Personnel" {{ old('designation') == 'Admin Admin Personnel' ? 'selected' : '' }}>Admin Admin Personnel</option>
              <option value="VP Office Admin Personnel" {{ old('designation') == 'VP Office Admin Personnel' ? 'selected' : '' }}>VP Office Admin Personnel</option>
              <option value="SAS Admin Personnel" {{ old('designation') == 'SAS Admin Personnel' ? 'selected' : '' }}>SAS Admin Personnel</option>
              <option value="IT Encoder" {{ old('designation') == 'IT Encoder' ? 'selected' : '' }}>IT Encoder</option>
              <option value="Guidance Admin Personnel" {{ old('designation') == 'Guidance Admin Personnel' ? 'selected' : '' }}>Guidance Admin Personnel</option>
            </select>
        ...
        <div class="col-md-6">
          <div class="form-floating">
            <input type="number" step="0.01" class="form-control" id="prev_abs" name="prev_abs" value="{{ old('prev_abs', 0) }}" min="0">
      ...
      <div class="row g-3 mb-3">
        <div class="col-md-4">
          <div class="form-floating">
            <input type="number" step="1" class="form-control bg-light" id="total_days" name="total_days" value="0" readonly>
            <label for="total_days">Total Days</label>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-floating">
            <input type="number" step="0.01" class="form-control" id="rate_per_day" name="rate_per_day" value="{{ old('rate_per_day', '0.00') }}" min="0">
            <label for="rate_per_day">Rate per Day (₱)</label>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-floating">
            <input type="number" step="0.01" class="form-control" id="deduction" name="deduction" value="{{ old('deduction', '0.00') }}" min="0">
