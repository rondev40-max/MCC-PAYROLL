...
<head>
  ...
  <title>Admin Personnel Timesheet — MCC Payroll</title>
...
<body>
  <div class="container-fluid">
    <div class="timesheet-card">
      ...
      <div class="print-header d-none">
        ...
        <h5 class="text-secondary mb-2">Admin Personnel Timesheet</h5>
      ...
      <div class="header-section">
        <div class="header-title-group">
          ...
          <h2>Admin Personnel Timesheet</h2>
        </div>
        <div class="header-actions">
          ...
          <a href="{{ route('admin-personnel.create') }}" class="btn-action-primary">
      ...
      <div class="controls-bar">
        <form method="GET" action="{{ route('admin-personnel.index') }}" class="filter-form">
            ...
            <tr>
              ...
              <td class="actions-column">
                <div class="action-btn-group">
                  <a href="{{ route('admin-personnel.edit', $timesheet->id) }}"
                     class="btn-circle"
                     title="Edit">
                  ...
                  <form action="{{ route('admin-personnel.destroy', $timesheet->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
            ...
            <tr>
              <td colspan="100" class="text-center py-5">
                <div class="empty-wrapper">
                  ...
                  <p class="mb-3">There are no admin-personnel timesheet entries to display.</p>
                  <a href="{{ route('admin-personnel.create') }}" class="btn btn-primary btn-action-primary">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                    Add First Timesheet
                  </a>
                </div>
  ...
  <script>
    ...
    function openPrintPage() {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          const printUrl = `{{ route('admin-personnel.print') }}?month=${month}&year=${year}&period=${period}`;
    ...
    // Calculations & Autosave (admin-personnel rules: total days is a day COUNT, not an hours
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function saveAllData(timesheetId, row) {
        ...
        Object.keys(allData).forEach(field => {
          const promise = fetch(`/admin-personnel/${timesheetId}/update-field`, {
            method: 'POST',
            headers: {
