...
<head>
  <meta charset="UTF-8">
  <title>Edit Admin Personnel Timesheet</title>
...
<body>
  <div class="main-content">
    <h2><i class="bi bi-pencil-square"></i> Edit Admin Personnel Timesheet</h2>
    ...
    <form action="{{ route('admin-personnel.update', $timesheet->id) }}" method="POST">
      @csrf
      @method('PUT')
      ...
      <div class="row g-3 mb-3">
        <div class="col-md-6">
          <div class="form-floating">
            <input type="text" class="form-control" id="employee_name" name="employee_name" value="{{ old('employee_name', $timesheet->employee_name) }}" placeholder="John Doe" required>
            <label for="employee_name">Employee Name</label>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-floating">
            <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $timesheet->email) }}" placeholder="name@gmail.com">
      ...
      <div class="row g-3 mb-4">
        <div class="col-md-3">
          <div class="form-floating">
            <select class="form-select" id="category" required>
              <option value="admin-personnel" selected>Admin Personnel</option>
            </select>
        ...
        <div class="col-md-3">
          <div class="form-floating">
            <select class="form-select @error('designation') is-invalid @enderror" id="designation" name="designation" required>
              ...
              <option value="BSIT Admin Personnel" {{ old('designation', $timesheet->designation) == 'BSIT Admin Personnel' ? 'selected' : '' }}>BSIT Admin Personnel</option>
              <option value="Registrar Admin Personnel" {{ old('designation', $timesheet->designation) == 'Registrar Admin Personnel' ? 'selected' : '' }}>Registrar Admin Personnel</option>
              <option value="Clinic Admin Personnel" {{ old('designation', $timesheet->designation) == 'Clinic Admin Personnel' ? 'selected' : '' }}>Clinic Admin Personnel</option>
              <option value="Library Admin Personnel" {{ old('designation', $timesheet->designation) == 'Library Admin Personnel' ? 'selected' : '' }}>Library Admin Personnel</option>
              <option value="Admin Admin Personnel" {{ old('designation', $timesheet->designation) == 'Admin Admin Personnel' ? 'selected' : '' }}>Admin Admin Personnel</option>
              <option value="VP Office Admin Personnel" {{ old('designation', $timesheet->designation) == 'VP Office Admin Personnel' ? 'selected' : '' }}>VP Office Admin Personnel</option>
              <option value="SAS Admin Personnel" {{ old('designation', $timesheet->designation) == 'SAS Admin Personnel' ? 'selected' : '' }}>SAS Admin Personnel</option>
              <option value="IT Encoder" {{ old('designation', $timesheet->designation) == 'IT Encoder' ? 'selected' : '' }}>IT Encoder</option>
              <option value="Guidance Admin Personnel" {{ old('designation', $timesheet->designation) == 'Guidance Admin Personnel' ? 'selected' : '' }}>Guidance Admin Personnel</option>
            </select>
        ...
        <div class="col-md-6">
          <div class="form-floating">
            <input type="number" step="0.01" class="form-control" id="prev_abs" name="prev_abs" value="{{ old('prev_abs', $timesheet->prev_abs) }}" min="0">
            <label for="prev_abs">Previous Absences</label>
          </div>
        </div>
      </div>
      ...
      <div class="days-section">
        ...
        <small class="text-muted d-block mt-3"><i class="bi bi-info-circle me-1"></i>Enter days worked. Any value > 0 counts as 1 day.</small>
      </div>

      <div class="mb-4">
        <div class="form-floating">
          <textarea class="form-control" id="details" name="details" placeholder="Enter details..." style="height: 100px">{{ old('details', $timesheet->details) }}</textarea>
      ...
      <div class="row g-3 mb-3">
        <div class="col-md-4">
          <div class="form-floating">
            <input type="number" step="1" class="form-control bg-light" id="total_days" name="total_days" value="{{ old('total_days', $timesheet->total_days) }}" readonly>
            <label for="total_days">Total Days</label>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-floating">
            <input type="number" step="0.01" class="form-control" id="rate_per_day" name="rate_per_day" value="{{ old('rate_per_day', $timesheet->rate_per_day) }}" min="0">
            <label for="rate_per_day">Rate per Day (₱)</label>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-floating">
            <input type="number" step="0.01" class="form-control" id="deduction" name="deduction" value="{{ old('deduction', $timesheet->deduction) }}" min="0">
